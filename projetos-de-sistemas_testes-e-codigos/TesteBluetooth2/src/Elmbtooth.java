...
//            StreamConnection st_connect=(StreamConnection)Connector.open(connectionURL);
            StreamConnection st_connect=(StreamConnection)Connector.open(connectionURL, 8, true);
            ...
            System.out.println(object.getCalculatedResult());
            System.out.println(object.getFormattedResult());
        }   
