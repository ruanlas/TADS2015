...
public class MessageAlerts {
	...
	public static Optional<ButtonType> confirmLogout() {
		Alert confirmationLogout = new Alert(Alert.AlertType.CONFIRMATION);
		confirmationLogout.setTitle("Logout");
		confirmationLogout.setHeaderText("Deseja realmente efetuar o logout?");
		Optional<ButtonType> result = confirmationLogout.showAndWait();
		return result;
	}
}
