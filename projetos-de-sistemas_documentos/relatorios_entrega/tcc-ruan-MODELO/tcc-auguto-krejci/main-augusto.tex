...
\usepackage{setspace}
\usepackage{color}
\usepackage[abnt-etal-list=3,abnt-etal-text=default,abnt-and-type=&,abnt-emphasize=bf,abnt-full-initials=yes,alf,bibjustif,abnt-cite-style=AUTHORYEAR]{abntcite}
...
\finalcatalog{1. Machine Learning 2. Recurrent Neural Network } %% Aqui fica % escrito a palavra ``T\'itulo'' mesmo, nao o do trabalho. Se tiver coorientador, os dados ficam depois dos dados 
...
%% Ficha Catalografica
%\inserecatalog
\includepdf[pages=1-]{Ficha_catalog.pdf}

%% Folha de aprovacao
\include{1-pre-textuais/1-folhadeaprovacao}

% Dedicatoria (opicional)
\include{1-pre-textuais/2-dedicatoria}


%% Agradecimentos. OPCIONAL. CASO SEJA BOLSISTA, INSERIR OS DEVIDOS AGRADECIMENTOS.
%\include{1-pre-textuais/3-agradecimentos}
\include{2-textuais/4-epigrafe}
\include{2-textuais/resumo}
\include{2-textuais/abstract} 
...
\include{2-textuais/cap2}
\include{2-textuais/cap3}
\include{2-textuais/cap4}
\include{2-textuais/cap5}
\include{2-textuais/cap6}
\include{2-textuais/cap7}
%% ----------------------------------------------------------
\pagestyle{scrplain} 
...
\bibliography{2-textuais/bibliografia}
