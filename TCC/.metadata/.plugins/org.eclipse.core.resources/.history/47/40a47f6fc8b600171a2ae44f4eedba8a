...
//        object.setResponseTimeDelay(9600L);
...
////		obj.setResponseTimeDelay(9600L);
...
//		labelMedicao.carregarElemento(obj.getFormattedResult());
	...
	public void speed() throws IOException, InterruptedException {
		SpeedCommand obj = new SpeedCommand();
		obj.run(inStream, outStream);
		labelMedicao.carregarElemento(obj.getFormattedResult());
	}
