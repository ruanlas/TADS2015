...
public class ConsultaMedicoes extends AsyncTask<Object, Object, Void> {
    private ListView lstViewTodasMedicoes;
    private String listaJsonString;
    private ArrayList<JSONObject> listJsonObjects;
    private ArrayAdapter<JSONObject> adapter = null;
    private ConsultarMedicoesActivity consultarMedicoesActivity;
    ...
    public ConsultaMedicoes(ListView lstViewTodasMedicoes, TextView txtStatus, ConsultarMedicoesActivity consultarMedicoesActivity) {
        this.lstViewTodasMedicoes = lstViewTodasMedicoes;
        this.consultarMedicoesActivity = consultarMedicoesActivity;
    ...
    protected Void doInBackground(Object... objects) {
        ...
        try {
            ...
            URL url = new URL("http://18.231.62.135:5000/collection");
...
//        edtTxtEnderecoCEP.setText(enderecoCEP);
        adapter = new ArrayAdapter<JSONObject>(consultarMedicoesActivity, android.R.layout.simple_list_item_1, listJsonObjects);
        lstViewTodasMedicoes.setAdapter(adapter);
        txtStatus.setText("Listagem de todas as medições completa!");
    }
