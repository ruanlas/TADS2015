...
import br.com.ninjadevs.runnables.RunnableIntervalo;

public class TesteComIntervalos {
	...
	public static void main(String[] args) {
		...
		Thread thread = new Thread(new RunnableIntervalo(directory, start, end, result));
