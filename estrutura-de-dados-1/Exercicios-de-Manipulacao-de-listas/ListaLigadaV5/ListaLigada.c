...
int main(){
    ...
    printf("\n\nInterseccao\n\n");
    imprimeLista(&listaA);
    //a inserção na listaB está dando erro. Durante a execução, o ultimo
    //elemento faz um apontamento para um endereço 'desconhecido', ao invés de apontar para NULL
    imprimeLista(&listaB);
    //uniao(&listaA, &listaB);
    system("PAUSE");
    return 0;
