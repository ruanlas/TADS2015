...
namespace SiEs___v._2
{
    public partial class Estimativa : Form
    {
        ...
        //variavel que faz o controle do botão levantar materiais, que permite
        //Apontar o proximo material que será necessário para uma determinada
        //atividade do orçamento
        int controladorBotao = 0;
        //variável que faz o controle de relacionamento do orçamento com o tipo de atividade
        ...
        {
            //Este método armazena o orçamento no banco
            Dados ObjDados = new Dados();
            try
            {
