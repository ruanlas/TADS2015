...
public class TesteDeBancos {
	public static void main(String[] args) {
		...
		System.out.println("Quarto objeto de índice -1799267502: "+ bancoArmazenamento.buscarPorId(-1799267502));
		System.out.println("Primeiro Objeto de índice -1278919335: "+ bancoArmazenamento.buscarPorId(-1278919335));
		System.out.println("Objeto de índice 5: "+bancoArmazenamento.buscarPorId(5));
